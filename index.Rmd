...
Babe Ruth: playerID, teamID, yearID, HR. First and last name, name.
...
Let's get the career homerun totals for players. Limit the display to just those that hit at least 600HR. Highest homerun totals at the top. First and last names, HR total.
